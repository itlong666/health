...
public class SMSUtils {
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws ClientException {
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4FhWrftzxr3FakeQP9kx";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "PV1EyEjz6QzqZw76utJdU4RfqsYAdn";// 你的accessKeySecret，参考本文档步骤2
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_182415429");
